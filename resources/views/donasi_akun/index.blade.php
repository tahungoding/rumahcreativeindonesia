...
@section('breadcrumb')
    {{Breadcrumbs::render('donasi_akun.index')}}
@endsection
            ...
            <div class="card-body">
                ...
                <p class="card-title-desc">
                    @if (Auth::user()->userLevel->nama == 'Admin')
                        <a href="{{ route('donasi_akun.create') }}" class="btn btn-primary waves-effect waves-light">
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap"
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{ $campaign_account->directory->name }}</td>
                            @if (Auth::user()->userLevel->nama == 'Admin')
                                <td>
                                    <div class="button-items">
                                        <a href="{{ route('donasi_akun.edit', $campaign_account) }}"
                                            class="btn btn-outline-warning waves-effect waves-light" data-toggle="tooltip"
                                            data-placement="top" title="Edit">
                                            <i class="ti-pencil"></i></a>

                                        <form action="{{ route('donasi_akun.destroy', $campaign_account) }}" method="post"
