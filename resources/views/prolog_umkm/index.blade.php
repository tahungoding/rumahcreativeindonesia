...
@section('breadcrumb')
    {{Breadcrumbs::render('prolog_umkm.index')}}
@endsection
            ...
            <div class="card-body">
                ...
                <p class="card-title-desc">
                    @if (Auth::user()->userLevel->nama == 'Admin') 
                        <a href="{{ route('prolog_umkm.create') }}" class="btn btn-primary waves-effect waves-light">
                            ...
                            @if (Auth::user()->userLevel->nama == 'Admin')
                                <td>
                                    <div class="button-items">
                                        <a href="{{ route('prolog_umkm.edit', $prol) }}" class="btn btn-outline-warning waves-effect waves-light" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="ti-pencil"></i></a>
                                        <form action="{{ route('prolog_umkm.destroy', $prol) }}" method="post" onsubmit="return confirm('Yakin hapus data ini?')" style="display: inline">
                                            @csrf
                                            @method('delete')
