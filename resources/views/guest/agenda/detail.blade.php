            ...
            <div class="col-lg-8">
                ...
                <div class="blog-details">
                    ...
                    <div class="blog-details-image">
                        <img src="{{avatar($agenda->gambar)}}" data-rjs="2" alt="">
                    </div>
                    ...
                    <div class="post-meta">
                        <ul class="list-inline">
                            <li>Penyelenggara: <a href="#"> {{$agenda->penyelenggara}} </a></li>
                            <li>Waktu: <a href="#"> {{tgl_indo($agenda->tanggal_awal)}} - {{tgl_indo($agenda->tanggal_akhir)}} </a></li>
                        </ul>
                    </div>
                    <!-- Post Meta End -->
                    ...
                    {{-- <div
                        ...
                        <div class="single-post-pagination media align-items-center mb-50 mb-md-0">
                            ...
                            <div class="media-body">
                                <a href="#" class="d-inline-flex align-items-center"><img
                                        src="{{asset('assets/front/img/icons/angle-left.svg')}}" data-rjs="2"
                                        class="svg" alt="">previous</a>
                        ...
                        <div class="single-post-pagination next media flex-row-reverse align-items-center">
                            <div class="pagination-image">
                                <a href="#"><img src="{{asset('assets/front/img/blog/nav2.png')}}" data-rjs="2"
                                        alt=""></a>
                            </div>
                            <div class="media-body text-right">
                                <a href="#" class="d-inline-flex flex-row-reverse align-items-center"><img
                                        src="{{asset('assets/front/img/icons/angle-right.svg')}}" alt=""
                                        class="svg">next</a>
